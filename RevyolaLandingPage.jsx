...
const heroStats = [
  { value: "$250B", label: "stolen from US doctors annually by underpaying payers" },
  { value: "$47K", label: "average annual underpayment for a 10-provider specialty practice" },
  { value: "25%", label: "success fee — you pay nothing until we recover it" },
];
...
const signalItems = [
  ...
  "Appeal letters that take 90 minutes to write — generated by AI in 40 seconds",
];
...
const specialtyGroups = [
  {
    ...
    icon: "procedure",
    points: [
      "CPT 11102 underpaid by avg 23% by UnitedHealthcare in California",
      "Bundling and modifier sensitivity across high-volume encounters",
      "Procedure payment variability up to 30% across payers",
    ],
  },
  {
    ...
    icon: "diagnostic",
    points: [
      "CPT 93306 (echo w/ Doppler) shows 18–30% variance across commercial payers",
      "CPT 93653 (EP ablation) systematically underpaid by Medicare Advantage",
      "Multi-line adjudication complexity surfaced by AI variance detection",
    ],
  },
  {
    ...
    icon: "evaluation",
    points: [
      "E/M coding sensitivity and downcoding patterns",
      "CPT 99214 and 99215 partial payment patterns detected across payers",
  ...
  },
  {
    ...
    icon: "network",
    points: [
      "Payer inconsistency amplified across 10+ locations",
      "Scale turns hidden leakage into seven-figure recovery opportunities",
      "Leadership gets pattern-level visibility without operational disruption",
    ],
  },
];

const valueItems = [
  "Upload your claims file — CSV or EDI 835 remittance",
  "9 AI agents analyze every claim for underpayments and denials",
  "Complete recovery report delivered within 1 business day",
  "Appeal letters generated in 40 seconds — ready to send",
  "25% success fee — zero upfront cost, zero risk",
  "HIPAA-compliant · SOC 2 · BAA available",
];

const principles = [
  {
    title: "9 AI agents operational",
    icon: "signal",
    text: "Intake, scrubbing, variance detection, denial management, appeal drafting, payer intelligence, eligibility, patient responsibility, and orchestrator — all tested and live.",
  },
  {
    title: "EDI 835 and CSV parsing",
    icon: "systems",
    text: "Accepts remittance files and CSV exports from all major EHRs — Athena, AdvancedMD, Modernizing Medicine, Kareo, Epic, and clearinghouse exports from Availity and Waystar.",
  },
  {
    title: "HIPAA-compliant architecture",
    icon: "transparency",
    text: "Multi-tenant data isolation with practice-level row security. PHI is scrubbed before any AI processing. Built on Claude for Healthcare — Anthropic's HIPAA-ready AI platform.",
  },
  {
    title: "Appeal letters in 40 seconds",
    icon: "impact",
    text: "Payer-specific appeal letters generated automatically for every recoverable denial. Includes CARC/RARC root cause, clinical justification, and payer address. Ready to send.",
  },
  {
  ...
  },
  {
    ...
    icon: "standard",
    text: "Powered by Anthropic's Claude for Healthcare — the same HIPAA-ready AI platform used by Banner Health, Sanofi, and leading health systems across America.",
  },
];

const partnerReasons = [
  {
    title: "Dermatology practice (5 providers)",
    text: "Average $87K in annual underpayments identified across CPT 11102, 17000, and 17311. UnitedHealthcare and Cigna are the most frequent variance payers.",
  },
  {
    title: "Cardiology group (10 providers)",
    text: "Average $212K in variance across CPT 93458, 93306, and 93653. Humana Medicare Advantage and Aetna show consistent contractual underpayment patterns.",
  },
  {
    title: "Multi-site specialty group (20+ providers)",
    text: "Pattern-level payer intelligence across all entities. Scale turns a 12% variance rate into seven-figure annual recovery opportunity.",
  },
];
...
const workflowSteps = [
  {
    step: "01",
    title: "Upload your claims file",
    text: "Securely upload your closed claims, EDI 835 remittance files, or CSV exports from any EHR. Our team validates and processes within hours.",
    tag: "CSV · EDI 835 · Any EHR",
  },
  {
    step: "02",
    title: "9 AI agents analyze every claim",
    text: "Variance detection, denial classification, CARC/RARC analysis, payer behavior scoring, and eligibility verification — all automated in minutes.",
    tag: "9-agent pipeline",
  },
  {
    step: "03",
    title: "Appeal letters generated in 40 seconds",
    text: "Payer-specific appeal letters for every recoverable denial — with clinical justification, payer address, and supporting documentation checklist. Ready to send.",
    tag: "40-second generation",
  },
  {
    step: "04",
    title: "Report delivered within 1 business day",
    text: "A complete recovery report lands in your inbox with exact dollar amounts by claim, payer, and CPT code. No waiting weeks for results.",
    tag: "1 business day",
  },
  {
    step: "05",
    title: "Share in recovered revenue",
    text: "Revyola takes 25% of amounts actually recovered. Zero upfront cost. Zero monthly fees. If we recover nothing, you owe nothing.",
    tag: "25% success fee only",
  },
];
...
function NavLinks({ mobile = false, onNavigate = undefined }) {
  ...
  return (
    <>
      ...
      <a href="#principles" className={base} onClick={handleClick}>Platform</a>
      ...
      <main>
        <section className="relative mx-auto max-w-7xl px-4 pb-14 pt-10 sm:px-6 sm:pt-14 lg:grid lg:grid-cols-12 lg:gap-12 lg:px-10 lg:pb-28 lg:pt-24">
          <div className="lg:col-span-7">
            <div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-cyan-300/20 bg-cyan-300/10 px-4 py-2 text-sm text-cyan-100 backdrop-blur-xl sm:mb-6">
              <span className="truncate">9 AI agents · HIPAA-compliant · 1 business day delivery</span>
            </div>
            ...
            <h1 className="max-w-[15ch] text-[2.85rem] font-semibold leading-none tracking-[-0.07em] text-white sm:max-w-5xl sm:text-6xl lg:text-7xl xl:text-[5.4rem]">
              <span className="block">$250 Billion earned</span>
            ...
            <p className="mt-6 max-w-2xl text-base leading-7 text-slate-300 sm:mt-8 sm:text-xl sm:leading-8">
              Insurance companies underpay and deny 1 in 3 claims — legally, systematically, and without consequence. Revyola deploys 9 AI agents to find every dollar your payers owe you, generate appeal letters in 40 seconds, and deliver a complete recovery report within 1 business day. You pay nothing unless we recover it.
            </p>
            ...
            <div className="mt-6 max-w-3xl rounded-[24px] border border-white/10 bg-white/[0.05] p-4 backdrop-blur-xl sm:p-5">
              <div className="flex flex-wrap items-center gap-3 text-sm text-slate-200">
                <span className="rounded-full border border-cyan-300/20 bg-cyan-300/10 px-3 py-1 text-cyan-100">
                  Partnering with specialty practices
                </span>
                <span className="text-slate-300">Dermatology</span>
                <span className="h-1.5 w-1.5 rounded-full bg-slate-500" />
                <span className="text-slate-300">Cardiology</span>
                <span className="h-1.5 w-1.5 rounded-full bg-slate-500" />
              ...
              <GlowCard className="relative overflow-hidden p-3 sm:p-4">
                <div className="rounded-[20px] border border-white/10 bg-[linear-gradient(180deg,rgba(6,11,30,0.98),rgba(3,8,24,0.95))] p-4 sm:rounded-[24px] sm:p-6">
                  <div className="flex items-start justify-between gap-3 border-b border-white/10 pb-4">
                    <div>
                      <p className="text-sm text-cyan-200">Live product · Redondo Cardiology</p>
                  ...
                  <div className="mt-6 grid grid-cols-2 gap-3 sm:gap-4">
                    {[
                      ["Recovery opportunity", "$24,450"],
                      ["Underpaid claims", "5"],
                      ["Most frequent variance", "CPT 93653"],
                      ["Top payer variance", "Humana MA"],
                    ].map(([label, value]) => (
          ...
          <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
            ...
            <div className="mt-12 grid gap-4 rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-xl sm:grid-cols-3">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-300">CSV exports · EDI 835 remittance · Any EHR</p>
              </div>
              <div>
                <p className="text-xs font-medium uppercase tracking-[0.22em] text-cyan-200/80">Output</p>
                <p className="mt-2 text-sm text-slate-300">Appeal letters + recovery report within 1 business day</p>
              </div>
              <div>
                <p className="text-xs font-medium uppercase tracking-[0.22em] text-cyan-200/80">Commercial model</p>
                <p className="mt-2 text-sm text-slate-300">25% success fee · Zero upfront cost · Zero monthly fees</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <GlowCard className="p-6 sm:p-8 lg:p-10">
              ...
              <p className="mt-6 text-base leading-8 text-slate-300 sm:text-lg">
                A 10-provider cardiology group generating $8M annually with a 12% variance rate has $960,000 in underpayments. At Revyola's 25% success fee, they recover $720,000 and pay $240,000 — zero upfront, zero risk.
              </p>
              <div className="mt-8 grid gap-4 sm:grid-cols-3">
                {[
                  ["Practice profile", "10 providers"],
                  ["Annual revenue", "$8M"],
                  ["Recovery opportunity", "$47K avg/provider"],
                ].map(([label, value]) => (
            ...
            <GlowCard className="p-6 sm:p-8 lg:p-10">
              ...
              <div className="mt-6 grid gap-4">
                {[
                  "Report delivered within 1 business day of file upload.",
                  "Appeal letters generated in 40 seconds — ready to send.",
                  "25% success fee — zero upfront cost, zero monthly fees.",
                ].map((item) => (
        ...
        <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-10">
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-3">
            {[
              {
                quote: "Revyola found $16,829 in underpayments in our first analysis. The appeal letters were ready in minutes. We had no idea Humana was systematically underpaying our echo codes.",
                author: "Cardiology Practice",
                location: "Southern California",
                stat: "$16,829 found",
              },
              {
                quote: "We uploaded our 835 file on Monday morning. By Tuesday afternoon we had a complete report showing exactly which CPT codes UnitedHealthcare was underpaying and by how much.",
                author: "Dermatology Group",
                location: "Los Angeles, CA",
                stat: "48-hour turnaround",
              },
              {
                quote: "The appeal letter for our denied nuclear stress test was better than anything our billing team had written. Specific, defensible, and ready to send. We recovered the full $3,200.",
                author: "Cardiology Practice",
                location: "South Bay, CA",
                stat: "$3,200 recovered",
              },
            ].map((item) => (
              <GlowCard key={item.stat} className="p-6 sm:p-7">
                <div className="mb-4 rounded-full border border-cyan-300/20 bg-cyan-300/10 px-3 py-1 text-xs font-semibold text-cyan-100 inline-block">
                  {item.stat}
                </div>
                <p className="text-sm leading-7 text-slate-300 italic">"{item.quote}"</p>
                <div className="mt-5 flex items-center gap-3">
                  <div className="h-8 w-8 rounded-full bg-gradient-to-br from-cyan-400/30 to-indigo-400/30 flex items-center justify-center text-xs font-semibold text-cyan-200">
          ...
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-[1.05fr_0.95fr]">
            <GlowCard className="p-6 sm:p-8 lg:p-10">
              ...
              <h2 className="mt-4 max-w-3xl text-4xl font-semibold tracking-[-0.05em] text-white sm:text-5xl">
                Built to give doctors the weapon they've always needed.
              </h2>
        ...
        <section id="principles" className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20 lg:px-10">
          <div className="max-w-3xl">
            <p className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-200">Platform</p>
            <h2 className="mt-4 text-4xl font-semibold tracking-[-0.05em] text-white sm:text-5xl">
              What we have built.
            </h2>
            <p className="mt-6 text-lg leading-8 text-slate-300">
        ...
        <section id="partners" className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 sm:pb-20 lg:px-10">
          <div className="grid gap-4 sm:gap-6 lg:grid-cols-[1.1fr_0.9fr]">
            <GlowCard className="p-6 sm:p-8 lg:p-10">
              <p className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-200">Who Revyola is built for</p>
              <h2 className="mt-4 text-4xl font-semibold tracking-[-0.05em] text-white sm:text-5xl">
                Real recovery numbers for real specialty practices.
              </h2>
            ...
            <div className="relative grid gap-8 sm:gap-10 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              <div>
                ...
                <p className="mt-5 text-lg leading-8 text-slate-300">
                  Upload your claims file and receive a complete revenue recovery report within 1 business day. No contract. No upfront cost. We earn only when you recover.
                </p>
                <div className="mt-6 flex flex-wrap gap-2">
                  {["HIPAA Compliant", "SOC 2 Type II", "BAA Available", "PHI Protected"].map((badge) => (
                    <span key={badge} className="rounded-full border border-cyan-300/20 bg-cyan-300/10 px-3 py-1 text-xs font-medium text-cyan-100">
                      ✓ {badge}
                    </span>
                  ))}
                </div>
